...
import org.jhipster.timesheet.domain.Client;
import org.jhipster.timesheet.repository.ClientRepository;
...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().firstname(DEFAULT_FIRSTNAME).lastname(DEFAULT_LASTNAME).email(DEFAULT_EMAIL).phone(DEFAULT_PHONE);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().firstname(UPDATED_FIRSTNAME).lastname(UPDATED_LASTNAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
        return client;
    }
    ...
    void putNewClient() throws Exception {
        ...
        updatedClient.firstname(UPDATED_FIRSTNAME).lastname(UPDATED_LASTNAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.firstname(UPDATED_FIRSTNAME).lastname(UPDATED_LASTNAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
