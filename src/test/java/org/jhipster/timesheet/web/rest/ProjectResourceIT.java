...
import org.jhipster.timesheet.repository.ProjectRepository;
...
class ProjectResourceIT {
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().projectName(DEFAULT_PROJECT_NAME);
        return project;
    }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project().projectName(UPDATED_PROJECT_NAME);
        return project;
    }
    ...
    void putNewProject() throws Exception {
        ...
        updatedProject.projectName(UPDATED_PROJECT_NAME);
