...
class UserInfoResourceIT {
    ...
    void putNewUserInfo() throws Exception {
        ...
        updatedUserInfo.firstname(UPDATED_FIRSTNAME).lastname(UPDATED_LASTNAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    ...
    void partialUpdateUserInfoWithPatch() throws Exception {
        ...
        partialUpdatedUserInfo.email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    ...
    void fullUpdateUserInfoWithPatch() throws Exception {
        ...
        partialUpdatedUserInfo.firstname(UPDATED_FIRSTNAME).lastname(UPDATED_LASTNAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
